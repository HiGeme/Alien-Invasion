...
def update_screen(ai_settings, screen, ship, aliens, bullets):
    #На каждой итерации цикла перерисовывается экран.
...
def create_fleet(ai_settings, screen, ship, aliens):
    ...
    alien = Alien(ai_settings, screen)
    number_aliens_x = get_number_aliens_x(ai_settings, alien.rect.width - 20)
...
def update_aliens(ai_settings, aliens):
    '''Проверяет, достиг ли флот края экрана, после чего обновляет позиции пришельцев во флоте'''
